...
public class Evaluator extends Throwable{
   public static double evaluate(String post) throws DivideByZeroException, MismatchedParenthesesException, ZeroExpoZeroException, OperandExpectedException, OperatorExpectedException, NegativeBaseException{
               ...
               case "^":
                  if (a == 0 && b == 0){
                    throw new ZeroExpoZeroException("Cannot raise 0 to the power of 0", 0);
                  	...
                  	throw new NegativeBaseException("Cannot have a negative base", 0);
                  }
   ...
   public static void main(String[] args) throws Exception{
      ...
      while (sc.hasNextLine()){
         ...
         try{
            String postfixExp = Transformer.toPost(infix);
